...
function Contact() {
  return (
    <div id="contact" className="my-10 w-full dark:bg-background bg-background  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex flex-col items-center justify-center">
