...
const FAB = () => {
    return (
        <div class="group fixed bottom-0 right-0 p-4  flex items-end justify-end w-24 h-24 ">
            ...
            <div class="text-white shadow-xl flex items-center justify-center p-3 rounded-full bg-gradient-to-b from-blue-300 to-pink-300 dark:from-blue-800 dark:to-purple-800  z-50 absolute  ">
