...
const FAB = () => {
  ...
  return (
    <div class="group fixed bottom-10 right-10 z-50  flex items-end justify-end w-28 h-28 ">
      <div class="text-white flex items-center justify-center p-4 rounded-full bg-transparent border-2 border-silver z-20 absolute  ">
      ...
      <Link href={"https://wa.link/723unf"} target='_blank' className='bg-transparent border-2 border-silver absolute rounded-full transition-all duration-[0.2s] ease-out scale-x-0 group-hover:scale-x-100 group-hover:-translate-y-16  flex  text-white'>
        <ItemImg path={"/telephone.svg"} />
      </Link>
      <Link href={"tel:+918848118309"} target='_blank' className='bg-transparent border-2 border-silver absolute rounded-full transition-all duration-[0.2s] ease-out scale-x-0 group-hover:scale-x-100 group-hover:-translate-y-14 group-hover:-translate-x-14 flex text-white'>
