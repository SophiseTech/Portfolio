...
function Works() {
  return (
    <div className="p-6 md:px-0 pt-16 md:w-11/12 flex flex-col gap-20 md:gap-80 items-center">
...
const WorkItem = ({ work }) => (
  <div className={`w-full md:w-11/12 flex flex-col md:flex-row gap-5 justify-between odd:md:flex-row-reverse group`}>
