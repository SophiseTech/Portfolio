...
function Testimonials({ imgSrc, Review, CustomerData }) {
    return (
        ...
        < div className="w-[50vw] h-full bg-gradient-to-b from-blue-300 to-pink-300 dark:from-blue-800 dark:to-purple-800 p-px  m-auto " >
            <div className=" p-10 h-full  bg-background flex justify-start items-center gap-5 ">
