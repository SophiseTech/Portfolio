...
function Footer() {
  return (
    <div className="relative overflow-hidden w-10/12 m-auto px-5 py-14">
      <div className="flex justify-between items-start">
        <div className="text-3xl font-semibold font-neo uppercase w-1/3">Nyon</div>
        <div>
      ...
      <div className="bg-gradient-to-r from-neutral-400 to-neutral-700 pb-[1px] mt-14"></div>
